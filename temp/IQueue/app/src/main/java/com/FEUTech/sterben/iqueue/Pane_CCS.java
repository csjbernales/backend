...
public class Pane_CCS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pane_ccs);

        Intent in = getIntent();
        Bundle b = in.getExtras();
        number = b.getString("num");
        currentqueue1 = (TextView) findViewById(R.id.currentqueue_ccs);
        specifiedqueue1 = (TextView) findViewById(R.id.specifiedqueue_ccs);
        pop1 = (TextView) findViewById(R.id.pop_ccs);
...
//                    Toast.makeText(Pane_Cashier.this, "insidestop", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(Pane_CCS.this, Queue_Empty.class);
                    i.putExtras(bi);
//                    stopService(intent);
                    startActivity(i);
...
//                    Toast.makeText(Pane_Cashier.this, "i", Toast.LENGTH_SHORT).show();
    ...
    public void materialdialogdeleteconfirmationccs(View v) {

        mMaterialDialog = new MaterialDialog(Pane_CCS.this)
                ...
                .setPositiveButton("OK", new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Query query = ref.child("CCS Transactions").orderByChild("myCurrentQueue").equalTo(myqueueGlobalHolder);
                            ...
                            public void onCancelled(DatabaseError databaseError) {
                                ...
                                SnackbarManager.show(
                                        Snackbar.with(getApplicationContext())
                                                .text("Network Problem"), Pane_CCS.this);
                            }
                        });

                        RestAdapter adapter = new RestAdapter.Builder().setEndpoint(ROOT_URL).build();
                        Queue_CCS_Delete_Data api = adapter.create(Queue_CCS_Delete_Data.class);
                        api.deleteUserfromCCS(
                                number, new Callback<retrofit.client.Response>() {
                                    ...
                                    public void success(final retrofit.client.Response result, retrofit.client.Response response) {
                                        ...
                                        mMaterialDialog2 = new MaterialDialog(Pane_CCS.this)
                                                ...
                                                .setPositiveButton("Done", new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        ...
                                                        Bundle bi = new Bundle();
                                                        bi.putString("num", number);
                                                        Intent i = new Intent(Pane_CCS.this, Screen_Home.class);
                                                        i.putExtras(bi);
                                                        cancelflags();
                                                        startActivity(i);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Bundle bi = new Bundle();
        bi.putString("num", number);
        Intent i = new Intent(Pane_CCS.this, Screen_Add_Queue.class);
        i.putExtras(bi);
        startActivity(i);
        overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);
        return true;
    ...
    public void onBackPressed() {
        ...
        Bundle bi = new Bundle();
        bi.putString("num", number);
        Intent i = new Intent(Pane_CCS.this, Screen_My_Queue.class);
        i.putExtras(bi);
        startActivity(i);
        overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);
    ...
    private void getMyQueue() {
        ...
        String url = "http://iqueuesystem.com/steb/getmycurrentqueue_ccs.php?studentID=" + number;
