...
public class Queue_Registrar extends AppCompatActivity {
    ...
    @NonNls
    private String id, term, year, top, myqueue, fireId, id123, contactnum, finalResult;
    @NonNls
    ...
    private Spinner spinnerprofcheck;
    ...
    private ArrayList<ULocale.Category> categoriesList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.queue_registrar);
        categoriesList = new ArrayList<ULocale.Category>();
