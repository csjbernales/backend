    ...
    public void onBindView(final int position, View itemView) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (position) {
                    case 0:
                        Intent intent2 = new Intent(context, Screen_Add_Queue_Redirector.class);
                        String zero = "0";
                        ...
                        break;
                    case 1:
                        Intent intent3 = new Intent(context, Screen_Add_Queue_Redirector.class);
                        String one = "1";
                        ...
                        break;
                    case 2:
                        Intent intent4 = new Intent(context, Screen_Add_Queue_Redirector.class);
                        String two = "2";
                        ...
                        break;
                    case 3:
                        Intent intent5 = new Intent(context, Screen_Add_Queue_Redirector.class);
                        String three = "3";
