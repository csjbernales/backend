...
public class Pane_Accounting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pane__accounting);
...
//                    Toast.makeText(Pane_Cashier.this, "insidestop", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(Pane_Accounting.this, Queue_Empty.class);
                    i.putExtras(bi);
//                    stopService(intent);
                    startActivity(i);
...
//                    Toast.makeText(Pane_Cashier.this, "insidestop", Toast.LENGTH_SHORT).show();
                        ...
                        bi.putString("office_type", "accounting");
...
//                    Toast.makeText(Pane_Cashier.this, "i", Toast.LENGTH_SHORT).show();
    ...
    public void materialdialogdeleteconfirmation(View v) {
        ...
        mMaterialDialog = new MaterialDialog(Pane_Accounting.this)
                ...
                .setPositiveButton("OK", new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Query query = ref.child("Accounting Transactions").orderByChild("myCurrentQueue").equalTo(myqueueGlobalHolder);
                            ...
                            public void onCancelled(DatabaseError databaseError) {
                                ...
                                SnackbarManager.show(
                                        Snackbar.with(getApplicationContext())
                                                .text("Network Problem"), Pane_Accounting.this);
                            }
                        });

                        RestAdapter adapter = new RestAdapter.Builder().setEndpoint(ROOT_URL).build();
                        Queue_Accounting_Delete_Data api = adapter.create(Queue_Accounting_Delete_Data.class);
                        api.deleteUserfromAccounting(
                                number, new Callback<retrofit.client.Response>() {
                                    ...
                                    public void success(final retrofit.client.Response result, retrofit.client.Response response) {
                                        ...
                                        mMaterialDialog2 = new MaterialDialog(Pane_Accounting.this)
                                                ...
                                                .setPositiveButton("Done", new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        ...
                                                        Bundle bi = new Bundle();
                                                        bi.putString("num", number);
                                                        Intent i = new Intent(Pane_Accounting.this, Screen_Add_Queue.class);
                                                        i.putExtras(bi);
                                                        cancelflags();
                                                        startActivity(i);
    ...
    public void onBackPressed() {
        ...
        Bundle bi = new Bundle();
        bi.putString("num", number);
        Intent i = new Intent(Pane_Accounting.this, Screen_My_Queue.class);
        i.putExtras(bi);
        startActivity(i);
        overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);
    ...
    private void getMyQueue() {
        ...
        String url = "http://iqueuesystem.com/steb/getmycurrentqueue_accounting.php?studentID=" + number;
